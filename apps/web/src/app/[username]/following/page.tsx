...
import { useUserByUsername, useUserFollowing, useAuth } from '@quillty/api';
    ...
    <div className="min-h-screen bg-gray-50 pb-24 lg:pb-8">
      ...
      <header className="sticky top-0 z-30 border-b border-gray-100 bg-white/90 backdrop-blur-xl">
        <div className="flex h-16 items-center gap-4 px-4 lg:px-6">
          ...
          <div>
            <h1 className="text-lg font-semibold text-gray-900">Following</h1>
      ...
      <div className="mx-auto max-w-2xl px-4 py-6">
        {following && following.length === 0 ? (
          <div className="py-16 text-center">
            <div className="text-6xl">&#128100;</div>
            <h2 className="mt-4 text-xl font-semibold text-gray-900">Not following anyone yet</h2>
            <p className="mt-2 text-gray-500">
              When @{username} follows someone, they&apos;ll appear here.
            </p>
          </div>
        ) : (
